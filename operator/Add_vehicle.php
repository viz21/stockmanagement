...
<body class="hold-transition skin-blue sidebar-mini">
  <?php
    ...
    return $data;
           ...
           $vehiclenum = $type = $size = $fueltype = $servicemileage= $status = $currentmileage ="";
            $vehiclenumErr = $typeErr = $sizeErr = $fueltypeErr= $servicemileageErr= $statusErr =$currentmileageErr= "";
         ...
         if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            // $servicemileage = test_input($_POST["servicemileage"]);
             ...
             //$vehiclenum = test_input($_POST["vehiclenum"]);
              ...
              if($vehiclenumErr == "" and $typeErr =="" and $sizeErr =="" and $fueltypeErr ==""and $statusErr=="" and $servicemileageErr=="" and $currentmileageErr==""){
                   
                 date_default_timezone_set("Asia/Colombo");
              $date_=date("d.m.Y"); 

                 $sql = "Insert INTO addvehicle(vehiclenum,type,size,fueltype,servicemileage,status,currentmileage) VALUES('$vehiclenum','$type','$size','$fueltype','$servicemileage','$status','$currentmileage')";
                        $result = mysqli_query($conn, $sql);
                        if ($result) {
                            echo "Successfully Created";
                            //header("Location:./V_vehicle.php");
                            $sql1 = "Insert INTO vehiclemileage(vehiclenum,date_,s_mileage,f_mileage,m_perday) VALUES('$vehiclenum','$date_','0','$currentmileage','0')";
        ...
        <script type="text/javascript"> 
          swal({
           ...
           document.location.href = "./Add_vehicle.php?valid=0";
          })
        </script>
        <?php
