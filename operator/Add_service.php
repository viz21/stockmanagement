...
<body class="hold-transition skin-blue sidebar-mini">
  <?php
    ...
    return $data;
            ...
            $vehiclenum=$servicecost= "";
            $vehiclenumErr=$servicecostErr="";
            ...
            date_default_timezone_set("Asia/Colombo");
             $date_=date("d.m.Y"); 
              ...
              if(empty($_POST["servicecost"])){
                $servicecostErr ="Service Cost is required";

              }else{
                $servicecost = test_input($_POST["servicecost"]);
              }
             ...
             // $date_ = test_input($_POST["date_"]);
              ...
              if($vehiclenumErr == "" and $servicecostErr=="" ){
             $sql = "Insert INTO vehicleservice(vehiclenum,date_,servicecost) VALUES('$vehiclenum','$date_','$servicecost')";
              
                        $result = mysqli_query($conn, $sql);
                        if ($result) {
                            echo "Successfully Created";
                           // header("Location:./V_service.php");
        ...
        <script type="text/javascript"> 
          swal({
           ...
           document.location.href = "./Add_service.php";
          })
        </script>
        <?php

         $sql5 = "UPDATE addvehicle SET status = 0 where vehiclenum='".$vehiclenum."'";

        mysqli_query($conn,$sql5);
         $sql6 ="SELECT servicemileage as servicemileage FROM addvehicle WHERE vehiclenum='".$vehiclenum."'";
         mysqli_query($conn,$sql6);
         $result1 =  mysqli_query($conn, $sql6);
         $row1 = mysqli_fetch_array($result1);
         $servicemileage= $row1['servicemileage'];
         $final=$servicemileage+4000;

        $sql8 = "UPDATE addvehicle SET servicemileage='$final' where vehiclenum='".$vehiclenum."'";
        ...
        <?php
         ...
         // $description="servicecost  ";
           $description="servicecost for ".$vehiclenum.".";

          $data_ =array ('amount' => $servicecost,'description' => $description);
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                ...
                <span class="hidden-xs"><?php echo $_SESSION['user5'];?></span>
              </a>
              <ul class="dropdown-menu">
                ...
                <li class="user-header">
                  ...
                  <p>
                    <?php echo $_SESSION['user5'];?> - <?php echo $_SESSION['post5'];?>
                  </p>
                </li>
                <!-- Menu Body -->
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Add Service
      <small>Enter service Details</small>
    </h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active">Addservice</li>
    </ol>
  </section>
    ...
    <div class="row">
      ...
      <form class="form-horizontal" role="form" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
        ...
        <div class="col-md-12">
          ...
          <div class="col-md-7">
           <select name="vehiclenum" class="form-control" style="border-radius:7px">
             ...
             <?php
                $sql_ = "select vehiclenum from addvehicle where status = 1 ";
        ...
        <div class="col-md-12">
          ...
          <div class="col-md-7">
            <input type="text" name="servicecost" class="form-control"  placeholder="Enter Service Cost"   style="border-radius:7px">
            <span class="error"><?php echo $servicecostErr;?></span>
          </div>
          <div class="col-md-2">
        ...
        <div class="col-md-12">         
          <div class="row text-center" style="padding-top: 2%">
           <button type="submit" class="btn btn-primary">Add Service <i class="fa fa-user-plus"></i></button>
          </div>
        </div>   
      </form>
