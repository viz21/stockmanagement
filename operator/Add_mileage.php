      ...
      if(($servicemileage - $sum)<=1000){
        ...
        <script type="text/javascript"> 
          swal({
            ...
            document.location.href = "./Add_mileage.php";
          })
        </script>
...
<div class="content-wrapper">
  ...
  <section class="content" style="padding-top: 5%;padding-left: 5%">
    <div class="row">
      ...
      <form class="form-horizontal" role="form" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
        ...
        <div class="col-md-12">
          ...
          <div class="col-md-7">
           <select name="vehiclenum" class="form-control" id="vehiclenum" onchange="changeValue(this.value);" style="border-radius:7px">
    ...
    <div class="col-md-12">
      ...
      <div class="col-md-7">
        <input type="text" name="s_mileage" id="s_mileage1" class="form-control"  placeholder="Enter Starting Mileage"   style="border-radius:7px" readonly>
...
function changeValue(ret){
  ...
  xhttp.onreadystatechange = function() {
    if (xhttp.readyState == 4 && xhttp.status == 200) {
      document.getElementById("s_mileage1").value  = xhttp.responseText;

    }
  }
  xhttp.open("GET", "G_currentmileage.php?ret="+ret, true);
  xhttp.send();
