...
function test_input($data) {
     ...
     $vehicleid =(int)$_GET["vehicleid"];
             ...
             $vehiclenum = $type = $size = $fueltype =$servicemileage ="";
            $vehiclenumErr = $typeErr = $sizeErr = $fueltypeErr= $servicemileageErr ="";
      ...
      $sql3= "SELECT * from addvehicle where vehicleid=$vehicleid";
           ...
           /*  $vehiclenum = test_input($_POST["vehiclenum"]);
              ...
              */            
              ...
              if($vehiclenumErr == "" and $typeErr =="" and $sizeErr =="" and $fueltypeErr ==""){
             
             $sql = "UPDATE addvehicle SET vehiclenum='$vehiclenum',type='$type',size='$size',fueltype='$fueltype',servicemileage='$servicemileage' where vehicleid='$vehicleid'";
