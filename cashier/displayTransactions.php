...
?>
 ...
 <head>
  ...
  <title>Waligama Distributors |Transaction Details</title>
...
<div class="content-wrapper">
  ...
  <section class="content" style="padding-top: 5%;padding-left: 5%">
    <div class="row">
      ...
      <div class="row text-center">         
        ...
        <div class="card-box table-responsive">
          ...
          <div class="col-md-7">
            <input type="date" name="balanceDate"  class="form-control"  value="<?php echo htmlspecialchars($balanceDate);?>" style="border-radius:7px">
        ...
        <?php  
           ...
           $sql1 = "SELECT * FROM fin_transdetails";
           ...
           $transDate=$row['transDate'];
            ...
            if(isset($_POST['submit'])){
              $balanceDate = $_POST['balanceDate'];
              //date_format($balanceDate,"d.m.Y");
              $BalanceDate = date("d.m.Y", strtotime($balanceDate));
              //echo "balaneDate is : ".$BalanceDate;
            
          
          //if(strcmp($month,$selected_month)==0){
            //echo "Month is: ".$month;
           $sql2 = "SELECT * FROM fin_transdetails where transDate='$BalanceDate'";
    ...
    <form action="./newpdf/generateIncome.php" method="POST">      
      <button type="submit" class="btn btn-primary btn-lg">Print Daily Income</button>
    </form>
          <br>
    <form action="./newpdf/generateExpense.php" method="POST">
      <button type="submit" class="btn btn-primary btn-lg">Print Daily Expense</button>
    </form>
