...
$discountAmount=$_POST['discountAmount'];
	...
	$sql2="INSERT INTO fin_transdetails(transDate,transactionDate,type,description,amount) VALUES('$claimDate','$transactionDate','$type','$desc','$totamount')";
    ...
    // delete from claimedDiscount db
    $sql1="DELETE FROM fin_claimeddiscounts WHERE claimId='$claimId'";
    ...
    if($result1)
        ...
        header('Location:./claimDiscounts.php?valid=1');
