      ...
      <li class>
        ...
        <li class>
          <a href="chequeDetails.php">
            <i class="fa fa-check-square"></i> <span>Cheque Details</span>
            <span class="pull-right-container"></span>
          </a>
        </li>
        <li class>
          <a href="notClearChequeDetails.php">
            <i class="fa fa-times"></i> <span>Not Clear Cheque Details</span>
            <span class="pull-right-container"></span>
          </a>
        </li>
        <li class>
      ...
      <div class="row text-center">         
        ...
        <?php  
          ...
          //if(strcmp($month,$selected_month)==0){
            //echo "Month is: ".$month;
           $sql2 = "SELECT * FROM fin_transdetails where transactionDate='$BalanceDate'";
