  ...
  <!-------------------------------------- Table Start Here -------------------------------------------------------------->      
	 ...
	 ?>
        ...
        <?php
                                    ...
                                    $sql1 = "SELECT * FROM fin_chequedetails  ";
                                    ...
                                    echo "<tr>
                                        ...
                                        <td>"."<a href=cheque.php?chequeId=".$chequeId.">"."Clear </a></td>
                                        <td>"."<a href=notClearCheque.php?chequeId=".$chequeId.$retailerName.$Amount">"."Not Clear </a></td>
