...
<?php
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
           ...
           header('Location:./claim.php?claimId='.$claimId.'&amount='.$amount.'&percentage='.$percentage);
           header('Location:./claimExpense.php?claimId='.$claimId.'&amount='.$amount.'&percentage='.$percentage);
  }
