...
if($_SESSION['user2']){
 ...
 <head>
  ...
  <title>Waligama Distributors |Bounce Cheque Details</title>
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Dashboard
      <small>Cleared Cheque Details</small>
    </h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-home"></i> Home</a></li>
      <li class="active">Cleared Cheque Details</li>
    </ol>
  </section>
         ...
         <tbody>
           ...
           if($_GET['valid']==1){
             ...
             <script type="text/javascript"> 
              swal({
                ...
                document.location.href = "./notClearChequeDetails.php";
              })
            </script>
            <?php
          }
          if($_GET['valid']==2){
            ...
            <script type="text/javascript"> 
              swal({
                title: 'Successfull!',
                text: "Successfully deleted the cheque",
                type: 'success',
                showCancelButton: false,
                confirmButtonColor: '#3085d6',
                confirmButtonText: 'Ok'
          ...
          $sql1 = "SELECT * FROM fin_chequedetails WHERE status=1";
          ...
          while ($row = mysqli_fetch_array($result)) {
            ...
            <td>{$row['branch']}</td>
            <td>{$row['Brand']}</td>
            <td>"."<a href=bounce.php?chequeId=".$chequeId.">"."Delete </a></td>
