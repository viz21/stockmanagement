                 ...
                 <tbody>
                   <?php 
                               ...
                               while ($row=mysqli_fetch_array($s2)) {
                                echo "<tr><td>{$row['supplierName']}</td><td>{$row['ddate']}</td><td>{$row['stockName']}</td><td>{$row['purchasing_price']}</td><td>{$row['discount']}</td><td>{$row['diss_value']}</td><td>{$row['selling_price']}</td><td>{$row['qty']}</td></tr>\n";
