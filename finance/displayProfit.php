...
?>
 ...
 <head>
  ...
  <title>Waligama Distributors |Profit Details</title>
...
<div class="content-wrapper">
      ...
      <div class="row text-center">         
        ...
        <?php  
          ...
          //if(strcmp($month,$selected_month)==0){
            //echo "Month is: ".$month;
           $sql2 = "SELECT * FROM fin_transdetails where transactionDate LIKE '%".$selected_month."%'";
  ...
  <form action="./newpdf/generate-stock.php" method="POST">      
          <button type="submit" class="btn btn-primary btn-lg">Print a month report</button>
