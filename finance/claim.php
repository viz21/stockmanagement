...
$claimId=$_GET['claimId'];
    ...
    $type="Income";
    $desc="Claimed Discounts";


	$sql2="INSERT INTO fin_transdetails(transDate,type,description,amount) VALUES('$claimDate','$type','$desc','$amount')";
	...
	if($result1)
		...
		header('Location:./claimDiscounts.php');
