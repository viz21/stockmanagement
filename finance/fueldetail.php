...
if($_SESSION['user']){
 ...
 //include("../retailer/db.php");
  ...
  <head>
    ...
    <title>AE Crist Manager | Dashboard</title>
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Fuel Details</li>
    </ol>
  </section>
        ...
        <div class="card-box table-responsive">
         ...
         <tbody>
           <?php
                                ...
                                $sql1 = "SELECT * FROM tempvehiclefuel where status=1  ";
                                ...
                                while ($row = mysqli_fetch_array($result)) {
                                  ...
                                  <tr>
                                      ...
                                      <td><?php echo $row['fuelcost']; ?></td>
                                     
                                      <td><a href="payvehicle.php?id=<?php echo $id; ?>">PAY</a></td>
                                  </tr>
