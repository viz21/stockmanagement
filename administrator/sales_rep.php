...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Dashboard
      <small>Sales Representative's Progress</small>
    </h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-home"></i> Home</a></li>
      <li class="active">Sales Representative's Progress</li>
    </ol>
  </section>
         ...
         <table id="datatable-responsive"
                         ...
                         <tbody>
                            <?php
                                ...
                                $emp_id="";
                                $sql1 = "SELECT e.*,s.* FROM emp_detail e, sale_rep s WHERE e. emp_id = s. emp_id";
