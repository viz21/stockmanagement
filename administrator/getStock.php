...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Stock Details
      <small>View Stock Details</small>
    </h1>
    <ol class="breadcrumb">
        ...
        <div class="card-box table-responsive">
          ...
          <table id="datatable-responsive"
                  class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0"
                        ...
                        $sql = " SELECT * FROM supplier_stock WHERE id=$id";
                        ...
                        ?>
                        <tr>
                        <td><?php echo $slist[$i]['supplierName']; ?></td>
                        <td><?php echo $slist[$i]['stockName']; ?></td>
                        <td><?php echo $slist[$i]['qty']; ?></td>
                        <td><?php echo $slist[$i]['selling_price']; ?></td>
                        <td><?php echo ($slist[$i]['qty']*$slist[$i]['selling_price']); ?></td> 
                        </tr>
                              <?php                
                    }
                    ?>
