...
public function Header()
{
	...
	$this->Cell(0,6,"Monthly Payment Details Report",0,1,'C');
	$this->Ln(10);
...
$pdf->Table('SELECT retailerdetails.RetailerName, retailer_payment.Date_ as Date, retailer_payment.Price, retailer_payment.Method
FROM retailer_payment
INNER JOIN retailerdetails ON retailer_payment.RetailerID = retailerdetails.RetailerID
WHERE Date_ LIKE  "%'.$month.'%"');
$pdf->AddPage();
