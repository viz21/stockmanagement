 ...
 if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  /*  if ($retailernameErr == "" and  $shopnameErr == "" and  $addressErr== "" and  $conumberErr== "" and  $emailErr== ""  ) {
    ...
    if ($usernameErr == "" and  $passwordErr == "") {
      ...
      $sql = "Insert INTO auth_details(username,password,type,empId,empname) VALUES('$username','$password','$type','$empId','$empname')";
      $result = mysqli_query($conn, $sql);
      if ($result) {
                //echo "Successfully Created";
               // header('Location:retailerDetails.php');
         $sql1="UPDATE emp_detail SET value=1 WHERE emp_id=$empId";
        ...
        <script type="text/javascript"> 
          swal({
            title: 'Successfull!',
            text: "Successfully create an authentication",
            type: 'success',
            showCancelButton: false,
            confirmButtonColor: '#3085d6',
            confirmButtonText: 'Ok'
          }).then(function () {
            document.location.href = "./authenticationDetails.php";
          })
        </script>
        <?php
      } else
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Authentication
      <small>Authentication Details</small>
    </h1>
    <ol class="breadcrumb">
  ...
  <section class="content" style="padding-top: 5%;padding-left: 5%">
    <div class="row">
      ...
      <form class="form-horizontal" role="form" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
        ...
        <div class="col-md-12">
          <label for="Employee Name" class="col-md-3" style="padding-left:12%;padding-top:15px">
            Employee Name:
          </label>
          <div class="col-md-7">
           <select name="fname" class="form-control"  style="border-radius:7px">
            <option style="border-radius: 7px" value ='0'>--Please Select--</option>
            <?php
            
            $sql_ = "SELECT * from emp_detail where value=0";
            $list = mysqli_query($conn,$sql_);
            while ($row=mysqli_fetch_assoc($list)) {
             ?>
             <option value=<?php echo $row['emp_id']."/".$row['fname']."/".$row['lname'];?> ><?php echo $row['fname']." ".$row['lname'];?></option>
             <?php     
           }
           ?>
         </select>  
  ...
  <div class="col-md-12">
      <label for="Employee username" class="col-md-3" style="padding-left:12%;padding-top:15px">
         UserName:
      </label>
      <div class="col-md-7">
        <input type="text" name="username"  class="form-control"  placeholder="Enter username"   style="border-radius:7px" >
    ...
    <div class="col-md-12">
      <label for="Employee Password" class="col-md-3" style="padding-left:12%;padding-top:15px">
         Password:
      </label>
      <div class="col-md-7">
        <input type="password" name="password"  class="form-control"  placeholder="Enter Password"   style="border-radius:7px" >
  ...
  <div class="col-md-12">
          ...
          <div class="col-md-7">
           <select name="type" class="form-control"  style="border-radius:7px">
            <option style="border-radius: 7px" value ='0'>--Please Select--</option>           
