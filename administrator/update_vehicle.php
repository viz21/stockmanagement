...
$vehiclenum = $type = $size = $fueltype =$servicemileage = $currentmileage="";
$vehiclenumErr = $typeErr = $sizeErr = $fueltypeErr= $servicemileageErr = $currentmileageErr="";

$sql3= "SELECT * from addvehicle where vehicleid=$vehicleid";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $data_ = mysqli_fetch_array($rs, MYSQLI_NUM);
            ...
            /* if (empty($_POST["vehiclenum"])) {
              ...
              if(empty($_POST["servicemileage"])){
               $servicemileageErr = "Enter Service Mileage";
              }
             else
              {
             ...
             if(empty($_POST["currentmileage"])){
               $currentmileageErr = "Enter Current Mileage";
               }
              else
            {

               $currentmileage = test_input($_POST["currentmileage"]);
            }
              //$servicemileage = test_input($_POST["servicemileage"]);
              $vehiclenum = test_input($_POST["vehiclenum"]); 
           ...
           /*  $vehiclenum = test_input($_POST["vehiclenum"]);
              ...
              */            
              ...
              if($vehiclenumErr == "" and $typeErr =="" and $sizeErr =="" and $fueltypeErr =="" and $servicemileageErr=="" and $currentmileageErr==""){
               
               $sql = "UPDATE addvehicle SET vehiclenum='$vehiclenum',type='$type',size='$size',fueltype='$fueltype',servicemileage='$servicemileage',currentmileage='$currentmileage' where vehicleid='$vehicleid'";

               $result = mysqli_query($conn, $sql);
               if ($result) {
                
                            //header("Location:./V_vehicle.php");
                 $sql1 = "UPDATE vehiclemileage set f_mileage='".$currentmileage."'";
                 ...
                 <script type="text/javascript"> 
                  swal({
                   ...
                   document.location.href = "./vehicleDetails.php";
                 })
               </script>
               <?php
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Dashboard
      <small>Update Vehicle</small>
    </h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active">Update vehicle Details</li>
    </ol>
  </section>
  ...
  <section class="content" style="padding-top: 5%;padding-left: 5%">
    <div class="row">
      <div class="col-sm-11" style="background-color: #ffffff;padding: 3%;border-radius: 15px;">
        <div class="card-box table-responsive">
          ...
          <form class="form-horizontal" role="form" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
            <div class="col-md-12">
              ...
              <div class="col-md-7">
                <input type="text" name="vehiclenum" class="form-control"  placeholder="Enter vehicle Number" value="<?php echo htmlspecialchars($vehiclenum);?>"  style="border-radius:7px" readonly>
        ...
        <div class="col-md-12" style="padding-top:5px">
          <label for="Current Mileage" class="col-md-3" style="padding-left:12%;padding-top:5px">
           Current Mileage:
         </label>
         <div class="col-md-7">
           <input type="text" name="currentmileage" id="currentmileage" class="form-control"  placeholder="Enter Current Mileage"   style="border-radius:7px">
           <span class="error"><?php echo $currentmileageErr;?></span>
      ...
      <input type="hidden" name="vehicleid" class="form-control" value="<?php echo htmlspecialchars($vehicleid);?>" hidden="hidden">
      <div class="row">

        <div class="col-md-12">         
          <div class="row text-center" style="padding-top: 2%">
           <button type="submit" class="btn btn-primary">Update Vehicle <i class="fa fa-user-plus"></i></button>
         </div>
       </div>   
     </form>
