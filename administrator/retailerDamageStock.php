...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Dashboard
        <small>Return Stock Details</small>
      </h1>
      <ol class="breadcrumb">
    ...
    <section class="content" style="padding-top: 5%;padding-left: 5%">
        <div class="row">
            ...
            <div class="row text-center">
                <h1>Return Sales Details Table</h1>
            </div>
