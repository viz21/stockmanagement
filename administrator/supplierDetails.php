...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Supplier Details
        <small>View Supplier Details</small>
      </h1>
      <ol class="breadcrumb">
  ...
  <!-------------------------------------- Table Start Here -------------------------------------------------------------->      
             <div class="card-box table-responsive">
                 ...
                 <tbody>
                      <?php
                                ...
                                $Supid="";
                                $sql1 = "SELECT * FROM supplierdetails";
                                ...
                                while ($row = mysqli_fetch_array($result)) {
                                    ...
                                    echo "<tr>
                                        ...
                                        <td>"."<a href=editSupplier.php?Supid=".$Supid.">"."Update </a> / <a href=removeSup.php?Supid=".$Supid.">"."Remove</a></td>
                                            </tr>";   
                                            }
                                            ?>       
                </tbody>
          ...
          <div class="row text-center" style="padding-top: 2%">
           <!-- <button type="submit" class="btn btn-primary"  onclick="location.href ='http://waligama.sanila.tech/supplier/newpdf/generate-supplier.php'">Reports</i></button> -->
