...
<body class="hold-transition skin-blue sidebar-mini">
  <?php
   ...
   function test_input($data) {
    ...
    $fnameErr = $lnameErr = $addressErr = $telnumberErr = $mobnumberErr =$emailErr = "";
  $fname = $lname = $address = $telnumber = $mobnumber =$email = "";
   ...
   if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($_POST["telnumber"])) {
      $telnumberErr = "Telephone number is required";
    } else if (preg_match("/^[0-9]*$/", $_POST["telnumber"])) {
      $scount = strlen($_POST["telnumber"]);
      if ($scount < 10 or $scount > 10)
        $telnumberErr = "only 10 numeric values can add";
      else
        $telnumber = test_input($_POST["telnumber"]);
    }
    else {
     $telnumberErr = "Only numeric values can add";
    }
    ...
    if ($fnameErr == "" and  $lnameErr == "" and $addressErr == "" and $telnumberErr== "" and  $mobnumberErr== "" and $emailErr== "" ) {
      ...
      $sql = "Insert INTO supplierdetails(fname,lname,address,telnumber,mobnumber,email) VALUES('$fname','$lname','$address','$telnumber','$mobnumber','$email')";
...
<script type="text/javascript"> 
          swal({
            ...
            document.location.href = "./supplierRegister.php";
          })
        </script>
    ...
    <div class="row">
      ...
      <form class="form-horizontal" role="form" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
        ...
        <div class="col-md-12">
          ...
          <div class="col-md-7">
            <input type="text" name="lname" class="form-control"  placeholder="Enter Last Name"  style="border-radius:7px"><span class="error"><?php echo $lnameErr;?></span>
          </div>
          <div class="col-md-2">
            <i class="fa fa-user fa-2x"></i>
          </div>
        ...
        <div class="col-md-12">
          ...
          <div class="col-md-7">
            <input type="text" name="address" class="form-control"  placeholder="Enter the Addresss" style="border-radius:7px"><span class="error"><?php echo $addressErr;?></span>
          </div>
          <div class="col-md-2">
        ...
        <div class="col-md-12">
          <label for="telnumber" class="col-md-3" style="padding-left:12%;padding-top:15px">
            Telephone number:
          </label>
          <div class="col-md-7">
            <input type="text" name="telnumber" class="form-control"  placeholder="Enter the Telephone number " style="border-radius:7px"><span class="error"><?php echo $telnumberErr;?></span>
          </div>
          <div class="col-md-2">
        ...
        <div class="col-md-12">
          ...
          <div class="col-md-7">
            <input type="text" name="mobnumber" class="form-control" placeholder="Enter Mobile number" style="border-radius:7px"><span class="error"><?php echo $mobnumberErr;?></span>
          </div>
          <div class="col-md-2">
        ...
        <div class="col-md-12">
          ...
          <div class="col-md-7">
            <input type="email" name="email" class="form-control"  placeholder="Enter email address" style="border-radius:7px"><span class="error"><?php echo $emailErr;?></span>
            </div>
            <div class="col-md-2">
