...
//get damage stock transaction details
...
$amount=doubleval($_POST['totPrice']);

$description="Refund stock money from".$supplierName;
...
$result = mysqli_query($conn, $sql);
    ...
    if($result2){
        ...
        if($status==1){
            ...
            $dailyIncomr=$row['dailyExpense']+$amount;
