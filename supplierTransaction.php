...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($supplierName != "" and  $amount != "" and  $method != "") {
      ...
      $sql = "Insert INTO fin_transdetails(transDate,type,description,amount) VALUES('$view_date','$type','$supplierName','$amount')";
      ...
      if ($result) {
        ...
        $url = 'http://waligama.sanila.tech/supplier/get_payment.php';
        echo $amount; 
...
<footer class="main-footer">
  ...
  <script type="text/javascript">
    function changeValue(){
      ...
      $.ajax({
        type: "POST",
        url: 'http://waligama.sanila.tech/finance/api/getAmount.php',
        data: {id:id},
