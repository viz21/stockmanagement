...
<div class="content-wrapper">
  ...
  <section class="content" style="padding-top: 5%;padding-left: 5%">
    ...
    <div class="col-md-12">
      ...
      <div class="col-md-7">
        <input type="text" name="password"  class="form-control"  placeholder="Enter Password"   style="border-radius:7px" >
           ...
           <select name="type" class="form-control"  style="border-radius:7px">
            <option style="border-radius: 7px" value ='0'>--Please Select--</option>           
             <option value=2>Finance Manager</option>
			       ...
			       <option value=4>Warehouse Stock Management</option>
    ...
    <div class="col-md-12">         
      <div class="row text-center" style="padding-top: 2%">
        <input type="hidden" name="empname" value=<?php echo $row['fname']." ".$row['lname'];?>>
