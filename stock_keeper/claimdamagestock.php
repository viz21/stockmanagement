...
<div class="wrapper">
  ...
  <!-------------------------------------- Table Start Here -------------------------------------------------------------->      
          ...
          <form action="#" role="form" method="GET" action="refund.php">
          <div class="col-md-12">
          <label for="supname" class="col-md-3" style="padding-left: 12%;padding-top: 15px;">
                 Supplier name:
            </label> 
            <div class="col-md-7">
               <select  name="supname" id="supname" class="form-control" >
                  <option value="<?php echo htmlspecialchars($supplierName); ?>" style="border-radius: 7px">--Please Select--</option>
                               <?php 
                               $supname="Select * from send_damagestock";
        ...
        <?php  
          ...
          //if(strcmp($month,$selected_month)==0){
            //echo "Month is: ".$month;
           $sql = "SELECT * FROM send_damagestock where date_ LIKE '%.$selected_month.%' and supplierName ='$supplierName'";
   ...
   <input type="hidden" name="id" value="<?php echo $idstck;?>">
            <div class="col-md-12">         
