...
<script type="text/javascript"> 
          swal({
            ...
            document.location.href = "./claimdamagestock.php";
          })
        </script>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Dashboard
        <small>Damage Refund Stock </small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">View Damage Stock</li>
      </ol>
    </section>
    ...
    <section class="content" style="padding-top: 5%;padding-left: 5%">
        <div class="row">
            ...
            <div class="row text-center">         
             <h1>Damage Refund Stock</h1>
            </div>
                <div class="card-box table-responsive">

  <!-------------------------------------- Table Start Here -------------------------------------------------------------->      
         <form class="form-horizontal" role="form" method="GET" action="refund.php" enctype="multipart/form-data" name="lorystckform">
