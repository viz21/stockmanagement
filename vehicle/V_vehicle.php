  ...
  <section class="content" style="padding-top: 5%;padding-left: 5%">
           ...
           <?php
                                ...
                                while ($row = mysqli_fetch_array($result)) {
                                    ...
                                    echo "<tr>
                                        ...
                                        <td>{$row['size']}</td>
                                        <td>{$row['fueltype']}</td>
                                        <td>{$row['servicemileage']}</td>

                                            
                                            
                                        <td>"."<a href=R_vehicle.php?vehicleid=".$vehicleid.">"."Remove</a></td>
                                            </tr>";   
   ...
   <div class="col-md-12">         
      <div class="row text-center" style="padding-top: 2%">
       <!-- <button type="submit" class="btn btn-primary"  onclick="location.href ='http://waligama.sanila.tech/vehicle/newpdf/generate-vehi.php'">Print <i class="fa fa-user-plus"></i></button> -->
     </div>
   </div> 
