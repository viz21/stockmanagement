...
<!--      <script src="../assets/js/modernizr.min.js"></script>
    ...
    <div class="container">
        <div class="page-header">
            <h1 id="timeline">Retailers Details</h1>
        </div>
        <div class="row">
            <div class="col-sm-11">
                <div class="card-box table-responsive">
                 ...
                 <tbody>
                    ...
                    $sql1 = "SELECT * FROM retailerdetails";
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        <td><?php echo $row['CoNumber']; ?></td>
                        <td><?php echo $row['MobNumber']; ?></td>
                        <td><?php echo $row['Email']; ?></td>
                        <td><a href="update.php?RetailerID=<?php echo $retailerid;?>">Update</a></td>
                    </tr>
                    <?php
                     }
                    ?>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Dashboard
        <small>Retailer Details Table</small>
      </h1>
      <ol class="breadcrumb">
