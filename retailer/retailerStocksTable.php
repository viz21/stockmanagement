    ...
    <body>
        ...
        <div class="container">
            <div class="page-header">
                <h1 id="timeline">Retailers Stocks Details</h1>
            </div>
            <div class="row">
                <div class="col-sm-11">
                    <div class="card-box table-responsive">
                       ...
                       <tbody>
                           ...
                           $sql = "SELECT * FROM retailer_stocks";
  ...
  <!-------------------------------------- Table Start Here -------------------------------------------------------------->
               ...
               <!--  <table id="datatable-responsive"
                 ...
                 <tbody>
                    ...
                    <tr>
                        <td>udduu tsingisnisnisn</td>
                        <td>tle sfsdjfbskbfsdibs</td>
                        <td>scription</td>
                        <td>te</td>
                        <td>ime</td>
                        <td>st</td>
                    ...
                    <tr>
                     <td>tharuka Nanayakkara</td>
                     <td>lensklnfdlsnflsnflsnflsnsfs</td>
                     <td>ionsdfsmflsndlfsnfs</td>
                     <td>esf.sdnflsdnfsndfs</td>
                     <td>imesf.slfnlsd</td>
                     <td>testslfmsd;fsd</td>
                     <td>timesfms;fn;sd</td>
                         <td>est;sfmslfndsn</td>
                     <td>
                        <button>Edit</button>
