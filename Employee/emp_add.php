...
<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($fnameErr == "" and $lnameErr == "" and $addressErr == "" and $emailErr == "" and $telephoneErr == "" and $pos_idErr == "" and $salErr == "" and $nicErr == "" and $genderErr == "" and $posnameErr == "") {
                $sql = "Insert INTO emp_detail(fname,lname,address,email,telephone,pos_id,pos_name,nic,salary,gender) VALUES('$fname','$lname','$address','$email','$telephone','$pos_id','$posname','$nic','$sal','$gender')";
...
?>
    ...
    <div id="wrapper">
        ...
        <div>
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" name="basicsal" placeholder="Enter Basic Salary">
