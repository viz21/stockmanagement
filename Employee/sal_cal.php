...
?>
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      <!-- Logo -->
      <a href="sal_detail.php" class="logo">
        ...
        <div class="container">
          ...
          <div class="row panel panel-default panel-body">
           <div class="col-md-6 col-md-offset-5">
            ...
            <button id="submit" type="submit" class="btn btn-primary btn-lg">Calculate</button>
        </div>
...
<script type="text/javascript">
    ...
    $( "form" ).on( "submit", function( event ) {
       ...
       $.ajax({
            ...
            {
                document.location.href = "./sal_detail.php?valid=1";
            }
        });
