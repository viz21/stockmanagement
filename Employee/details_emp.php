      ...
      <div class="col-sm-11" style="background-color: #ffffff;padding: 3%;border-radius: 15px;">
        ...
        <div class="card-box table-responsive">
          ...
          <table id="datatable-responsive"
                            ...
                            <?php
                                ...
                                while ($row = mysqli_fetch_array($result)) {
                                    ...
                                    echo "<tr>
                                        ...
                                        <td>{$row['email']}</td>
                                        <td>{$row['gender']}</td>
                                        <td>"."<a href=update_emp.php?emp_id=".$emp_id.">"."Update</a></td>
                                        <td>"."<a href=emp_sal.php?emp_id=".$emp_id.">"."View</a></td>
            ...
            <div class="col-md-5">
                <!-- <button type="submit" class="btn btn-primary btn-lg" onclick="location.href ='http://waligama.sanila.tech/Employee/newpdf/generate-emp.php'">
