...
$url='http://waligama.sanila.tech/stock_mangement/api/lorry/sendDamageStock.php?token=stock1230';
    ...
    $response = curl_exec($ch);
     ...
     $url='http://waligama.sanila.tech/finance/api/getDamageRep.php?token=stock1230';
