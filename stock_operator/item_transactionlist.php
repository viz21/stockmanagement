...
<div class="wrapper">
  ...
  <!-------------------------------------- Table Start Here -------------------------------------------------------------->      
         <form class="form-horizontal" role="form" method="GET" action="transaction.php" enctype="multipart/form-data" name="lorystckform">
   ...
   <input type="hidden" name="id" value="<?php echo $idst;?>">
            <div class="col-md-12">         
