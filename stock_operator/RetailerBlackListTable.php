...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Dashboard
        <small>Black List Retailers</small>
      </h1>
      <ol class="breadcrumb">
  ...
  <!-------------------------------------- Table Start Here -------------------------------------------------------------->      
        ...
        <script type="text/javascript"> 
          swal({
            ...
            document.location.href = "./RetailerBlackListTable.php";
          })
        </script>
        <?php
		}		  
                           ...
                           $sql = "SELECT * FROM retailer_credits where BList=1 ";
