...
//jason adding to load_lorry_qty & unload_lorry_qty tables start
  ...
  if(isset($_POST["btn_submit"])){
   ...
   $sql = "SELECT * FROM tempextrastck WHERE empId=".$empId." ORDER BY temp_id";
...
//  $templorrynum= $_POST["lorrynumber"];
  ...
  $sql3= "INSERT INTO rep_d_fin (rep_id) VALUES('".$temprepnum."')"; 

  mysqli_query($conn, $sql3);

  $sqldel="DELETE FROM tempextrastck WHERE empId=".$empId;
...
{ 
 ...
 if($qntit>0){
  ...
  $sql3 = "INSERT INTO tempextrastck(stockID,productname,quntity,discount,sellingprice,supplierName,empId) VALUES('".$sid."','".$productname."','".$qntit."','".$discount."','".$sling_price."','".$supname."','".$empId."')";
  mysqli_query($conn, $sql3);
...
?>     <script type="text/javascript">
  swal({
    ...
    document.location.href = "./addlorrystock.php?supplier=<?php echo $supname?>";
  })
</script>
<?php 
}
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
     Dashboard
     <small>Lorrystock loading</small>
   </h1>
   <ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
    <li class="active"> Loading Lorry Stock</li>
  </ol>
</section>
...
<form class="form-horizontal" role="form"   method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data" name="lorystckform">
  ...
  <div class="col-md-6">
    ...
    $sql4="SELECT stockID,stockName FROM stock WHERE supplierName='$supplier' ORDER BY stockName ASC";
...
?>
<form class="form-horizontal" role="form"   method="GET" action="addlorrystock.php" enctype="multipart/form-data" name="stckslect">
        <div>  
         <label for="productname" class="col-md-4" style="padding-left:12%;padding-top:15px;">
          Supplier :
        </label>
       ...
       <div class="col-md-6">
        ...
        $sqlw = "SELECT supplierName FROM stock GROUP BY supplierName";
        ...
        <div class="row">
          <div class="col-sm-11">
            <div class="card-box table-responsive">
             ...
             $sqltemp = "SELECT * FROM tempextrastck WHERE empId=".$empId;
             ...
             <tbody>
               ...
               while($row = mysqli_fetch_assoc($resulttemp)){
                ...
                <td><a href='deletextra.php?temp_id=$delid&empId=$empId'>Delete</a> </td> 
                </tr>\n";
              }
              ?>
