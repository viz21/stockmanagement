...
<div class="wrapper">
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  <?php echo $_SESSION['user6'];?> - <?php echo $_SESSION['post'];?>
                </p>
              </li>
              <!-- Menu Body -->
 ...
 <aside class="main-sidebar">
  ...
  <!-------------------------------------- Table Start Here -------------------------------------------------------------->
                     ...
                     <tbody>
                         ...
                         while ($row = mysqli_fetch_assoc($result)) {
                          ...
                          /*  $SalesID=$row['SalesID'];
                            ...
                            $RetailerName=$row1['RetailerName'];
                            //echo $RetailerName;
                            $Id=$row['SalesID'];
                          ?>
                            <tr>
                                <td><?php echo $row1['ShopName']; ?> || <?php echo $row1['RetailerName']; ?></td>
                ...
                <td><a href="retailerfreestocks.php?id=<?php echo $Id; ?>">View</a></td>
                            </tr>
                        <?php
                        }
                        ?>
                    ...
                    <form action="./newpdf/generate-stock.php" method="POST">      
          <button type="submit" class="btn btn-primary btn-lg">Print free stock report</button>
