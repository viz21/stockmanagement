           ...
           <table id="datatable-responsive"
                 ...
                 <tbody>
                   <?php 
                               ...
                               $table="Select * from send_damagestock ";
                               ...
                               while ($row=mysqli_fetch_array($s2)) {
                                ...
                                echo "<tr>
            							...
            							<td><a href='refund_list.php?supplierName=$supplierName&id=".$id."'>Refund</a> | <a href='item_transactionlist.php?supplierName=$supplierName&id=".$id."'>Item Transaction</a></td>
                                            </tr>";   
                               ?>
