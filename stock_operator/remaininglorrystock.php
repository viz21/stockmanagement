...
<body class="hold-transition skin-blue sidebar-mini">
 ...
 // echo $var2[0]['temp_id'];
  ...
  for($x=0; $x<$elementcount; $x++){
   ...
   $sqlde2="DELETE FROM load_lorry_qty where lorryID='".$lorryid."'";
         mysqli_query($conn, $sqlde2); 
  ?>
      ...
      <script type="text/javascript"> 
          swal({
            ...
            document.location.href = "./remaininglorrystock.php";
          })
        </script>
...
<div class="content-wrapper">
  ...
  <section class="content-header">
   ...
   <ol class="breadcrumb">
    ...
    <li class="active"> Remaining Stock in lorries</li>
  </ol>
</section>
