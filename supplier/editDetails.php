  ...
  <section class="sidebar">
   ...
   <ul class="sidebar-menu" data-widget="treeview">
      ...
      <li class="active treeview">
        <a href="supplierRegister">
          <i class="fa fa-id-card"></i> <span>Supplier Registration</span>
          <a href="supplierDetails">
          <i class="fa fa-address-card-o"></i> <span>Supplier Details</span>
          <a href="viewStock">
          <i class="fa fa-bar-chart "></i> <span>View Stock</span>
          <a href="supplierPayment">
          <i class="fa fa-money"></i> <span>Supplier Payment Details</span>
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Enter Supplier Details</li>
    </ol>
  </section>
  ...
  <section class="content" style="padding-top: 5%;padding-left: 5%">
    <div class="row">
      ...
      <form class="form-horizontal" role="form" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
        <div class="col-md-12">
          <label for="First Name" class="col-md-3" style="padding-left:12%;padding-top:15px;">
            First Name:
          </label>
          <div class="col-md-7">
        ...
        <div class="col-md-12">
          ...
          <div class="col-md-7">
            <input type="text" name="shopname" class="form-control"  placeholder="Enter Last Name"  value="<?php echo htmlspecialchars($shopname);?>" style="border-radius:7px"><span class="error"><?php echo $shopnameErr;?></span>
          </div>
          <div class="col-md-2">
        ...
        <div class="col-md-12">
          <label for="Mobile" class="col-md-3" style="padding-left:12%;padding-top:10px">
            Mobile number:
          </label>
          <div class="col-md-7">
        ...
        <div class="col-md-12">
          <label for="emailaddress" class="col-md-3" style="padding-left:12%;padding-top:4px">
            Email address:
          </label>
