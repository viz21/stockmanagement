...
<script type="text/javascript"> 
          swal({
            ...
            document.location.href = "./damage_list.php";
          })
        </script>
 ...
 <li>
  <li class="active treeview">
      <a href="damage_list.php">
          <i class="fa fa-pencil"></i> <span>View Damage List</span>
          <span class="pull-right-container"></span>
        </a>
      </li>
       <li>
       <a href="view_stock.php">
          <i class="fa fa-plus"></i> <span>View Stock</span>
          <span class="pull-right-container"></span>
        </a>
      </li>
  ...
  <!-------------------------------------- Table Start Here -------------------------------------------------------------->      
         <form class="form-horizontal" role="form" method="GET" action="get_damagelist.php" enctype="multipart/form-data" name="lorystckform">
           <table id="datatable-responsive"
                 ...
                 <?php
                                ...
                                $sql1 = "SELECT * FROM warehouse_damage where status=0 and supplierName='".$supplierName."'";
