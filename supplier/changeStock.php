...
<body class="hold-transition skin-blue sidebar-mini">
  <?php
               ...
               /* if (empty($_POST["txtstockname"])){                              //stockname validation
                ...
                } else if (is_numeric($_POST["txtqty"])) {
                    $qty = test_input($_POST["txtqty"]);
                }
                else {
                    $qtyErr = "Only numeric values can add". $_POST["txtqty"];
                }
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Dashboard
      <small>Change Stock Details</small>
    </h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active">Change Stock Details</li>
    </ol>
  </section>
