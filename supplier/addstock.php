...
$supplierNameErr = $stockNameErr = $purchasing_priceErr = $disscountErr = $qtyErr = $dateErr = "";
$supplierName = $stockName = $purchasing_price = $disscount = $qty = $date = "";
             ...
             $status = 1 ;
                ...
                $totprice = $purchasing_price * $qty ;
//data addition to the db
                if ($supplierNameErr == "" and $stockNameErr == "" and $purchasing_priceErr == ""  and $disscountErr == ""  and $qtyErr == ""   and $dateErr == "" ){
                   
                $stockID = "" ;
                $sql = "INSERT INTO stock(supplierName,stockName,purchasing_price,qty,discount,diss_value,selling_price,ddate)VALUES('$supplierName','$stockName','$purchasing_price','$qty','$disscount','$diss_value',' $sellPrice','$date')";
                $result = mysqli_query($conn, $sql);
                  
                $supTransId = "" ;
                $sql1="INSERT INTO fin_supplierpayment (supplierName,stockName,totprice,status) VALUES ('$supplierName', '$stockName', '$totprice','$status')";
