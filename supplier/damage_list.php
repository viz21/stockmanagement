    ...
    <section class="sidebar">
      ...
      <li>
       ...
       <a href="damage_list.php">
          <i class="fa fa-plus"></i> <span>View Damage List</span>
          <span class="pull-right-container"></span>
        </a>
      </li>
       <li>
           ...
           <table id="datatable-responsive"
                 ...
                 <tbody>
                   <?php 
                               ...
                               $table="SELECT supplierName FROM warehouse_damage WHERE status=0  group by supplierName ";
                               ...
                               while ($row=mysqli_fetch_array($s2)) {
                                ...
                                <tr>
                                		...
                                		<td><?php echo $row['supplierName'];?></td>
            						        	...
            						        	<td><a href="send_email.php?supplierName=<?php echo $supplierName;?>">View Stock </a></td>
                                            </tr>;   
