...
$sql1 = "SELECT * FROM stock where StockID = $stockID";
$result = mysqli_query($conn, $sql1);
$row=mysqli_fetch_array($result);
$newqty=$row['qty'] - $_GET['qty'];


$sql4="UPDATE stock SET qty = $newqty WHERE stockID=$stockID";
mysqli_query($conn,$sql4);
 
  $sqld="DELETE  FROM damage_stock WHERE stockID='$stockID'";  //delete from rol_notify
		mysqli_query($conn,$sqld); 

 header('location:view_stock.php?valid=1');
