...
<script src="https://cdnjs.cloudflare.com/ajax/libs/core-js/2.4.1/core.js"></script>
  ...
  xhttp.open("GET", "remainingRET.php?itm="+itm, true);
  xhttp.send();
...
<div class="content-wrapper">
  ...
  <section class="content-header">
   ...
   <ol class="breadcrumb">
    ...
    <li class="active"> Remaining Lorry Stock</li>
  </ol>
</section>
     ...
     <div>
      ...
      <div class="col-md-6">
       ...
       <?php
                ...
                $sqlw = "SELECT * FROM unload_lorry_ret";
...
<?php
           ...
           while ($row = mysqli_fetch_array($resultw )) {
             echo "<option value='" . $row['retId'] ."'>" . $row['retName'] ."</option>";
           }
            echo "</select>";  
