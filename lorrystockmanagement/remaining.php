...
if($_SESSION['user']){
 ...
 //jason unload and deducting from warehouse stock
 if(isset($_POST["btnUNLOAD"]))
 {
  $lorrynum=$_POST["lorrynumb"];
  $sqlsearch="SELECT stock_details FROM unload_lorry_qty where lorryNumber='".$lorrynum."'";
 ...
 // echo $var2[0]['temp_id'];
  ...
  for($x=0; $x<$elementcount; $x++){
                                           ...
                                           $stockname=$var2[$x]['productname'];
                                             ...
                                             $sql="UPDATE stock SET qty=qty+'".$qty."' WHERE stockName='".$stockname."'";
                                             $result=mysqli_query($conn,$sql);
  }
    $sqldel="DELETE FROM unload_lorry_qty";
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
     Dashboard
     <small>Remaining quantity in lorries</small>
   </h1>
   <ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
    <li class="active"> Remaining LorryStock</li>
  </ol>
</section>
  ...
  <div class="row">
    <div class="col-sm-11" style="background-color: #ffffff;padding: 1%;padding-bottom: 3%;border-radius: 15px;">
     ...
     <div class="row text-center">         
      <h1>Remaining Lorrystock Details</h1>
    </div>
    <form name="remainform" action="" method="post">
     ...
     <div>
      ...
      <div class="col-md-5">
        ...
        <select name="lorrynumb"  class="form-control"  onchange="loadTable(this.value)">
         <option>--Please Select a lorrynumber--</option>

         <?php       while ($row = mysqli_fetch_array($result)) {
           echo "<option value='" . $row['lorrynumber']  ."'>" . $row['lorrynumber'] ."</option>";
         }
         echo "</select>";  
